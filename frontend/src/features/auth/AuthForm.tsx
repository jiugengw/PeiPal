    ...
    <div className="min-w-0 bg-background">
      ...
      >
        <button
          ...
          className={`min-h-11 cursor-pointer rounded-lg border-0 px-2 font-extrabold text-foreground disabled:cursor-not-allowed disabled:opacity-60 ${mode === "login" ? "bg-background underline decoration-2 underline-offset-[5px] shadow-[0_5px_16px_rgb(37_44_64_/_0.10)]" : "bg-transparent hover:bg-background/65"}`}
          type="button"
          role="tab"
        ...
        <button
          disabled={isSubmitting}
          className={`min-h-11 cursor-pointer rounded-lg border-0 px-2 font-extrabold text-foreground disabled:cursor-not-allowed disabled:opacity-60 ${mode === "signup" ? "bg-background underline decoration-2 underline-offset-[5px] shadow-[0_5px_16px_rgb(37_44_64_/_0.10)]" : "bg-transparent hover:bg-background/65"}`}
          type="button"
          role="tab"
        ...
        <form className="mt-3 grid gap-3" noValidate onSubmit={handleSubmit}>
          {mode === "signup" ? (
            <div className="grid gap-1">
              ...
              {errors.name ? (
                <p
                  className="m-0 text-[0.95rem] leading-[1.45] font-bold"
                  id="auth-name-error"
                >
                  Please check: {errors.name}
                </p>
              ) : null}
            </div>
          ) : null}
          ...
          <div className="grid gap-1">
            <label className="text-base font-extrabold" htmlFor="auth-email">
              Email address
            </label>
            <input
              disabled={isSubmitting}
            ...
            {errors.email ? (
              <p
                ...
                id="auth-email-error"
              >
                Please check: {errors.email}
              </p>
            ) : null}
          </div>

          <div className="grid gap-1">
            <label className="text-base font-extrabold" htmlFor="auth-password">
              Password
            </label>
            <div className="relative">
              ...
              <button
                disabled={isSubmitting}
                className="absolute inset-y-0 right-0 min-h-12 min-w-[72px] cursor-pointer rounded-r-xl border-0 bg-muted font-extrabold text-foreground hover:bg-accent disabled:cursor-not-allowed disabled:opacity-60"
                type="button"
            ...
            {mode === "signup" && !errors.password ? (
              <p
                className="m-0 text-[0.95rem] leading-[1.45]"
          ...
          <button
            disabled={isSubmitting}
            className="min-h-12 cursor-pointer rounded-xl border-0 bg-primary text-base font-extrabold text-primary-foreground hover:bg-foreground disabled:cursor-wait disabled:opacity-70"
            type="submit"
          >
            {isSigningIn
              ? "Logging in…"
          ...
          {submissionError ? (
            <p
              className="m-0 rounded-xl bg-muted p-[18px] leading-normal font-bold text-foreground"
              role="alert"
            >
              {submissionError}
            </p>
